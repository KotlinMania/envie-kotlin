...
kotlin {
    ...
    val xcf = XCFramework("Envie")

    macosArm64 {
        binaries.framework { baseName = "Envie"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Envie"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Envie"
        flattenPackage = "io.github.kotlinmania.envie"
    }

    android {
        namespace = "io.github.kotlinmania.envie"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "envie-kotlin", version.toString())

    pom {
        name.set("envie-kotlin")
        description.set("Kotlin Multiplatform process-environment toolkit: getenv / setenv / unsetenv / environ / isatty across native, JVM, JS, and Wasm targets.")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/envie-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/envie-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/envie-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/envie-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.envie.codeql
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleEnvieXCFramework",
    "assembleEnvieDebugXCFramework",
    "assembleEnvieReleaseXCFramework",
    "assembleDebugIosFatFrameworkForEnvieXCFramework",
    "assembleReleaseIosFatFrameworkForEnvieXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForEnvieXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForEnvieXCFramework",
    "assembleDebugMacosFatFrameworkForEnvieXCFramework",
    "assembleReleaseMacosFatFrameworkForEnvieXCFramework",
    "assembleDebugTvosFatFrameworkForEnvieXCFramework",
    "assembleReleaseTvosFatFrameworkForEnvieXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForEnvieXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForEnvieXCFramework",
    "assembleDebugWatchosFatFrameworkForEnvieXCFramework",
    "assembleReleaseWatchosFatFrameworkForEnvieXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForEnvieXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForEnvieXCFramework",
