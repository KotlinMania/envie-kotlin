# Agent guide - envie-kotlin

This file is the quick-reference operating contract for envie-kotlin. The longer
...
envie-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`envie`](https://crates.io/crates/envie). Upstream Rust is the behavioral oracle while the
